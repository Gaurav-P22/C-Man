...
<header>
  ...
  <?php
           ...
           {
            ?>
             <table class="table table-sm table-dark" style="background-color: #6d6875; color:#ffb4a2; border-radius:5px 15px; -webkit-box-shadow: 3px 3px 5px 6px #ccc;  -moz-box-shadow:3px 3px 5px 6px #ccc; box-shadow:  3px 3px 5px 6px #ccc;">
  <thead>
    <tr>
      <th scope="col">Id</th>
  ...
  <tbody>
    ...
    while($result=mysqli_fetch_assoc($data))
    {
      ...
      <td><button class="btn btn-primary" style="margin:-3px"><a class="text-light" href="update.php?updateid='.$result["id"].'">Update</a></button>
