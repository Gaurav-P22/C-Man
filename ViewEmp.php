...
<header>
          ...
          <div class="navbar-collapse collapse">
            <div class="menu">
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" style="color: red;"><a href="ViewEmp.php" id='co' style="color: red;">View Employee</a></li>
  ...
  <tbody>
    ...
    while($result=mysqli_fetch_assoc($data))
    {
      ...
      <td><button class="btn btn-primary"><a class="text-light" href="updateE.php?updateEid='.$result["id"].'">Update</a></button>
<button class="btn btn-warning"><a href="deleteE.php?deleteEid='.$result["id"].'"  class="text-light">Delete</a></button></td>
    </tr>';
