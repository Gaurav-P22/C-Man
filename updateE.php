...
=======
  ...
  <style>
    ...
    if (isset($_REQUEST['submit'])) {
      ...
      if (!empty($_GET['updateEid'])) {
        $employee_id = $_GET['updateEid'];
        $sql = "UPDATE employee2 SET name='$a', mobile='$b', address='$d', dob='$e', pincode='$f' WHERE id='$employee_id'";
      } else {
        // If no employee ID is provided, insert a new record
        header("location:updateE.php?msg=Errorr!!");
      }

      if (mysqli_query($con, $sql)) {
        $updateSuccess = true;
        header("location:ViewEmp.php?msg=Updation Successfully");
      } else {
        header("location:updateE.php?msg=Error!!!!!!!!!!!!!");
      }
    }
    ?>
>>>>>>> origin/master
...
<<<<<<< HEAD
            ...
            <div class="navbar-brand">
              <a href="admin.php"><h1><span style="color:red"><i>C-</i>&nbsp;&nbsp;<i style="color: Black">MAN</i>&nbsp;&nbsp;</span><i style="color: red">System</i></h1></a>
=======
              <span class="sr-only">Toggle navigation</span>
              <span class="icon-bar"></span>
              <span class="icon-bar"></span>
            ...
            <div class="navbar-brand">
              <a href="admin.php">
                <h1><span style="color:red"><i>C-</i>&nbsp;&nbsp;<i style="color: Black">MAN</i>&nbsp;&nbsp;</span><i style="color: red">System</i></h1>
              </a>
>>>>>>> origin/master
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div style="width: 100%; height:10%; background-color:white;">
          ...
          ?>
              ...
              // Add this code before rendering the form

              $con = mysqli_connect("localhost", "root", "", "project");

              if (!empty($_GET['updateEid'])) {
                $employee_id = $_GET['updateEid'];
                $result = mysqli_query($con, "SELECT * FROM employee2 WHERE id='$employee_id'");
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  <input name="name" placeholder="Name" class="form-control" type="text" value="<?php echo isset($row['name']) ? $row['name'] : ''; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                  ...
                  <input name="mno" placeholder="+91" class="form-control" type="text" value="<?php echo isset($row['mobile']) ? $row['mobile'] : ''; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                  ...
                  <input name="email" placeholder="E-Mail" disabled class="form-control" type="text" value="<?php echo isset($row['email']) ? $row['email'] : ''; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                  ...
                  <input name="add" placeholder="Address" class="form-control" type="text" value="<?php echo isset($row['address']) ? $row['address'] : ''; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                  ...
                  <input name="dob" placeholder="DOB" class="form-control" type="date" value="<?php echo isset($row['dob']) ? $row['dob'] : ''; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                  ...
                  <input name="pcode" placeholder="Pin" class="form-control" type="text" value="<?php echo isset($row['pincode']) ? $row['pincode'] : ''; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group" style="background-color: fb8500;">
              <label class="col-md-4 control-label"></label>
              <div class="col-md-4"><br>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button class="btn btn-warning" type="submit" name="submit">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSUBMIT <span class="glyphicon glyphicon-send"></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
              </div>
            </div>
