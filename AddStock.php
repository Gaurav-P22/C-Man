...
else{header("location:AddStock.php?msg=Error!!!!!!!!!!!!!");      
    }   
  }   
?>
  </style>
        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <div class="navbar-brand">
               <a href="index.php"><h1><span style="color:red"><i>C-</i>&nbsp;&nbsp;<i style="color: Black">MAN</i>&nbsp;&nbsp;</span></h1></a>
          </div>
          </div>
...
<!-- Form Name -->
<legend><center><h2 style="color: #003049;"><b>Add Stock</b></h2></center></legend><br>
...
<input  name="first_name"  class="form-control"  type="text" disabled value="<?php echo $val ?>">
</div>
</div>
</div>
